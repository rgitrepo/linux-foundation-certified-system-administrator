...
- [01-Essential Commands](docs/)
  ...
  - [10-Compare and manipulate file content](docs/)
  - [11-Search file using Grep](docs/)
  - [12-Analyze text using basic regular expressions](docs/)
  - [13-Extended Regular Expressions](docs/)
  - [14-Archive, backup, compress, unpack, and uncompress files (Optional)](docs/)
  - [15-Compress and Uncompress files (Optional)](docs/)
  - [16-Backup files to a Remote System (Optional)](docs/)
  - [17-Use input-output redirection](docs/)
  - [18-Work with SSL certificates✨](docs/)
  - [19-Git – Basic Operations✨](docs/)
  - [20-Git – Staging and Committing Changes✨](docs/)
  - [21-Git – Branches and Remote Repositories✨](docs/)
